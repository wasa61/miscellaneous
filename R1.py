    ...
    def __init__(self):
        ...
        self.q_controllers = {
            ...
            "SQUID_INK": QLearningController(actions=[
                {'take_width': 1, 'market_make_spread': -0.5, 'price_filter_width': 1, 'fallback_offset': 1, 'liquidate_width': 0.5},
                # {"take_width": 5, "market_make_spread": 1000, "price_filter_width": 1, "fallback_offset": -15, "liquidate_width": 1},
                # {"take_width": 5, "market_make_spread": 1000, "price_filter_width": 1, "fallback_offset": -16, "liquidate_width": 1},
                # {"take_width": 5, "market_make_spread": 1000, "price_filter_width": 1, "fallback_offset": -17, "liquidate_width": 1},
                # {"take_width": 5, "market_make_spread": 1000, "price_filter_width": 1, "fallback_offset": -18, "liquidate_width": 1},
            ]),
        }
