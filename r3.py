...
class Trader:
    def __init__(self):
        ...
        self.strategy_config = {
            ...
            "SQUID_INK": {
                "limit": 50,
                "take_order_args": {"prevent_adverse": False, "adverse_volume": 0, "take_width": 4},
                "liquidation_args": {"liquidate_width": 1},
                "market_make_args": {"market_make_spread": 1000, "price_filter_width": 1000, "fallback_offset": 1000},
                "true_value_args": {"use_fixed": False}
            }
        }
